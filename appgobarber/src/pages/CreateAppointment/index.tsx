...
const CreateAppointment: React.FC = () => {
  ...
  const afertenoonAvailability = useMemo(() => {
    return availability
      .filter(({ hour }) => hour >= 12)
      .map(({ hour, available }) => {
        return {
  ...
  }, [navigate, selectedProvider, selectedDate, selectdHour]);
